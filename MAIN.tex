...
\addtocategory{thesispapers}{Ainur2022}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{A methodology for repeatable and scalable research on latency-resource consumption trade-offs in Cyber-Physical Systems}
...
\include{publications/2022EdgeDroid2.tex}
\end{appendices}
