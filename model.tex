...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{publications/2023EdgeDroid2/figs/new_model/ttf_to_exectime}
    \caption{%
...
\begin{figure}
    \centering
    \includegraphics[height=25em]{publications/2023EdgeDroid2/figs/new_model/exectime_over_steps}
    \caption{%
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{publications/2023EdgeDroid2/figs/new_model/transitions}
    \caption{%
...
\begin{figure}
    \centering
    \includegraphics[width=.9\textwidth]{publications/2023EdgeDroid2/model_data/frame_probabilities}
    \caption{%
