...
In the following subsections, we detail the construction of a model which uses the data collected for \textcite{olguinmunoz:impact2021} to generate, at runtime, realistic execution times. 
...
The distribution chosen for the second variant described above corresponds to the \ac{exGaussian} distribution.
We've chosen this distribution due to the vast body of research supporting its suitability for the modeling of the timing of human actions~\cite{Rohrer1994analysis,Palmer2011shapes,Marmolejo2022generalised}.
