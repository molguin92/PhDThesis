...
\begin{figure}
    \centering
    \includegraphics[width=.9\textwidth]{publications/2023EdgeDroid2/figs/EdgeDroid2ExperimentalSetup}
    \caption{%
...
\begin{figure}
    ...
    \begin{subfigure}[t]{.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{publications/2023EdgeDroid2/figs/new_model/lifetime_testbed}
        \caption{%
    ...
    \begin{subfigure}[t]{.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{publications/2023EdgeDroid2/figs/new_model/lifetime_testbed_diff}
        \caption{%
