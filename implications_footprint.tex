...
This model represents a first-order approximation to empirical execution time modeling, and consist simply of an \gls{exGaussian} distribution fitted to all execution time samples collected for~\cite{olguinmunoz:impact2021}.
...
\begin{figure}
    ...
    \begin{subfigure}[]{\columnwidth}
        \centering
        \includegraphics[width=\textwidth]{publications/2023EdgeDroid2/figs/new_model/lifetime_all_ttfs.png}
        \caption{%
    ...
    \begin{subfigure}[]{\columnwidth}
        \centering
        \includegraphics[width=\textwidth]{publications/2023EdgeDroid2/figs/new_model/lifetime_diff.png}
        \caption{%
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{publications/2023EdgeDroid2/figs/EdgeDroid2ExperimentalSetup.png}
    \caption{%
...
\begin{figure}
    ...
    \begin{subfigure}[]{\columnwidth}
        \centering
        \includegraphics[width=\textwidth]{publications/2023EdgeDroid2/figs/new_model/lifetime_testbed.png}
        \caption{%
    ...
    \begin{subfigure}[]{\columnwidth}
        \centering
        \includegraphics[width=\textwidth]{publications/2023EdgeDroid2/figs/new_model/lifetime_testbed_diff.png}
        \caption{%
