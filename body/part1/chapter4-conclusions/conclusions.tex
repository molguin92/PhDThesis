...
Secondly, we have explored the implications of improved accuracy on the client-side emulation on the results produced with our methodology.
...
Our findings indicate that incorporating improved accuracy in client-side emulation can enable the implementation of otherwise unfeasible optimization approaches.
