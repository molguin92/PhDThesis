...
However, existing approaches tend to focus heavily on large-scale data processing and downlink transmission in Cloud scenarios, and are not applicable to the latency-sensitive, uplink-heavy characteristics of Edge Computing.
...
The limitations of previous approaches has in later years led to a number of works that have attempted to tackle this challenge in the context of Fog and Edge Computing as well.
...
Furthermore, none of these approaches have attempted to understand the relationship between latency and human performance in \gls{XR} applications deployed on the Edge.
...
It includes a built-in distributed video-analytics benchmark, but is designed to decouple orchestration and workload, allowing for easy extension of the latter.\@
