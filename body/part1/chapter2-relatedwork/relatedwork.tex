...
\subsubsection{Testbed research in Edge Computing}
...
\todo[inline]{
    At this point we have settled for experimental approach.
    No need to delve deep in math models and simulations, right?
}

\todo[inline]{
    Also, title again needs reworking.
}

\subsubsection{Experimental approaches to \gls{MAR} research}\label{sec:relwork:xremulation}
\todo[inline]{Rework to talk more generally about experimental research in MAR?}
...
\subsubsection{Experimental approaches to research in \glsfmtshortpl{NCS}}
\todo[inline]{
    Rework.
    Don't focus on repeatability argument.
    Argue that a generic front-end-emulated approach is needed for flexibility.
}
