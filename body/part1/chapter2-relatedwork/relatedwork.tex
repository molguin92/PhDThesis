...
Both these approaches focus heavily on data processing and downlink transmission in cloud computing scenarios.
...
It emulates three different workloads, speech-to-text, image recognition, and sensor network application traffic, and specifically targets serverless deployments.\@
...
\emph{DeFog} includes six latency-critical and bandwidth-intensive, Fog- and Edge-relevant workloads, including real-time video detection and a text-to-speech application.
