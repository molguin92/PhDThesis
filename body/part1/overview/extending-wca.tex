...
\begin{figure}[tb]
    ...
    \end{subfigure}
    \caption{%
        Comparison between normal task execution in the LEGO \ac{WCA}~\cite{chen2015early}~(\labelcref{sfig:regularwcaexec}) and modified task execution with delay in the experimental setup of \cref{paper:olguinmunoz2021impact}~(\labelcref{sfig:delaywcaexec}).
