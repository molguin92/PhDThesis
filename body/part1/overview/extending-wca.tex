\section{Extending the methodology in the context of \acs{WCA}}\label{sec:extendingmethodology}
...
\begin{enumerate}
    ...
    \item If \ensuremath{t_\text{norm} >= 1}, send a pre-selected \emph{success}-tagged frame for the current step to the \gls{WCA} backend.
