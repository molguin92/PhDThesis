...
In particular, we wish to explore the impact improving the accuracy of the client-side emulation has on the potential for optimization of the applications under evaluation.
...
By improving the accuracy of our model of human behavior, we aim to gain novel understanding of the challenges involved in optimizing \gls{WCA} and how our methodology can be effectively applied to address these.
This research highlights the importance of the accuracy of emulations as  crucial factor in the application of our methodology.
