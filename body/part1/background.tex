...
\todo[inline]{Something feels missing here}
...
\cite{chen2015early} and~\cite{chen2018application} further develop this platform, and produce a number of different assistive applications such as the aforementioned LEGO and IKEA assistants, and others such as a Ping-Pong assistant capable of providing real-time hints to players of table tennis.
Yet another platform for \gls{WCA} is introduced in~\cite{chatzopoulos2017hyperion}, with the goal of providing real-time contextual information in text-form to users.
...
In later years, an body of work studying the optimization of these applications has emerged.
...
As expressed above, existing studies of this class of applications have only recently started to delve more deeply upon these issues.add
