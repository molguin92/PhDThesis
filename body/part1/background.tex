...
Of principal interest to us are works dealing with the experimental optimization of \gls{WCA} and \glspl{NCS} deployed on distributed systems such as edge computing.
...
Research in edge computing is still in its early stages, although it has been steadily increasing in the last decade as researchers, businesses, and organizations recognize the benefits of bringing computing and storage capabilities closer to the source of data.
Standardization is however still a major unsolved challenge in this field, and thus most research hitherto has relied on ad-hoc methodologies and/or platforms.\todo{Citation}

Nonetheless, the last few years have seen the emergence of a number of small- to mid-scale platforms and testbeds for edge computing research.
