...
\todo[inline]{
    Too vague.
    Performance evaluation of what?
    Performance evaluation of Edge Computing?
...
\subsection{\glsfmtshort{CPS} and \glsfmtshort{MAR}}

\todo[inline]{
    Needs a better title.
    NCS and WCA?\@ Put everything under CPS?\@
}

\todo[inline]{
    Rework structure a bit.
}
...
\subsubsection{\glsfmtlongpl{NCS}}\label{background:ncs}
\glsreset{NCS}
