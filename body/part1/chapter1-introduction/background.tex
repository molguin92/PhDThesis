...
\todo[inline]{
Then, when it comes to WCA, please also go more into the details regarding the operation, the footprints and the QoS requirements. Alternatively, you can also defer the discussion of WCA entirely to section 2 (you could claim that WCA is simply a type of AR, and thus in section you 'choose' WCA as example application to conduct your studies - in the same way as the inverted pendulum is a type of NCS, that we choose to study further).
}
