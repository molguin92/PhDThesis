...
\todo[inline]{Maybe add a table where you compare cloud and edge computing regrading different characteristics?}
\glsresetall%
...
The original Edge Computing concept as introduced in~\citeauthor{satyanarayanan2009case} has come to be known as \emph{Cloudlet-based} Edge Computing.
