...
\begin{figure}
    ...
    \begin{subfigure}[t]{\textwidth}
        \centering
        \includegraphics[width=.8\textwidth]{Figs/trace_edgedroid.png}
        \caption{%
    ...
    \begin{subfigure}[t]{\textwidth}
        ...
        \caption{State diagram of the user model governing the replay of the pre-recorded trace at runtime.}\label{fig:usermodel}
    \end{subfigure}
    \caption{%
