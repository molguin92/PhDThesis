...
We summarize the seven key contributions of this thesis below:
...
\todo[inline]{
    \cref{paper:EdgeDroid1.0} introduces our methodology, and validates its use in studying WCA.
...
\todo[inline]{PLOS paper describes the acquisition of the necessary data and insights for the models.}
