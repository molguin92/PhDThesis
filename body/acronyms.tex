...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Acronyms}
\todo[inline]{Change to glossaries package.}
\begin{multicols}{2}
    \begin{acronym}
        ...
        \acro{CLEAVE}{ControL bEnchmArkin`g` serVice on the Edge}
        ...
        \acro{ARA}{Agricultural and ruRAl communities}
        \acro{UHF}{Ultra-High Frequency}
        \acro{MIMO}{Multi-Input Multi-Output}
        \acro{CHI}{CHameleon Infrastructure}
        \acro{CMU}{Carnegie Mellon University}
        \acro{GSR}{Galvanic Skin Response}
        \acro{EEG}{electroencephalography}
        \acro{BFI}{Big Five Inventory of personality traits~\cite{john1999big}}
        \acro{ITQ}{Immersive Tendencies Questionnaire~\cite{witmer1998measuring}}
    \end{acronym}
\end{multicols}