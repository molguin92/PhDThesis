...
% \todo[inline]{
%     COSMOS: Experimenters work on these resources using the \ac*{OMF}~\cite{omf} tool, originally leveraged for ORBIT~\cite{orbit}, and \gls{SSH} sessions, thus allowing for free-form scripting of experimental procedures.
...
%     POWDER: To abstract and redistribute resources and \acp{API}, \gls{POWDER} leverages the concept of \emph{profiles}, corresponding shareable packages containing experimental configurations and descriptions\cite{emulab}.
