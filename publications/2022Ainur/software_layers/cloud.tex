...
This \gls{AMI} can be either be one of the default \acp{AMI} provided by \acp{AWS} --- e.g.\ a plain Ubuntu or CentOS \gls{AMI} --- or a custom \gls{AMI} which has been preconfigured by the user.
