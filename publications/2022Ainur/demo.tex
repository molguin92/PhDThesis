...
\begin{figure*}
    ...
    \caption[caption]{%
        ...
        \end{enumerate*}.
    }\label{paper:olguinmunoz2022airnur:fig:democonfigs}
\end{figure*}
...
\Cref{paper:olguinmunoz2022airnur:fig:democonfigs} illustrates the possible configurations for the testbed.
...
\begin{description}
    \item[WiFi:] \pgls{SDR} is configured as an IEEE 802.11n access point, and client hosts connect to it using on-board Wi-Fi.
...
The second workload (\cref{paper:olguinmunoz2022airnur:fig:wkld:ncs}) corresponds to \pgls{NCS} balancing an inverted pendulum, implemented on a software framework for the emulation of \glspl{NCS} using cloud-native technologies~\cite{olguinmunoz2022cleave}.
