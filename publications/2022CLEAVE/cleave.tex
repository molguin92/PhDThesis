...
In this section, we detail our \gls{CLEAVE} framework for the performance evaluation of \aclp{NCS}, with an emphasis on edge deployments.
...
This allows for great flexibility, as the core components of the \gls{NCS} can be switched out while maintaining the realism of the network, the most complex and limiting component of edge \acp{NCS}.
