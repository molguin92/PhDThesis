...
\end{alignat}
Note that, for periodic sampling, this function is a constant, which is equal to the sampling frequency. In the aperiodic case, it is argued in \cite{secAperiodic} that this rate function is strictly increasing and the optimum ap
