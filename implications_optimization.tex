...
\begin{figure*}
    ...
    \begin{subtable}[t]{.6\textwidth}
        ...
        \begin{tabular}{lrrr}
            \toprule
            Sampling scheme & \SI{150}{\milli\second} & \SI{300}{\milli\second} & \SI{600}{\milli\second} \\
            \midrule
            Adaptive (ED2 LN) & \num{14.69} & \num{8.07} & \num{5.10} \\
            Adaptive (ED2 HN) & \num{14.60} & \num{8.03} & \num{5.05} \\
            Adaptive (ED2 LN, ExG fit) & \num{15.30} & \num{8.23} & \num{5.09} \\
            Adaptive (ED2 HN, ExG fit) & \num{15.05} & \num{8.47} & \num{5.20} \\
            Adaptive (reference, gaussian fit) & \num{20.17} & \num{10.65} & \num{6.04} \\
            Greedy & \num{36.68} & \num{19.11} & \num{10.36} \\
            \bottomrule
        \end{tabular}
    \end{subtable}\\
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=.8\textwidth]{figs/new_model/diff_sampling_junjue.png}
        \caption{%
...
\todo[inline]{Discuss that lower RTTs lead to better results?}
