...
\begin{figure}
    ...
    \begin{subfigure}[]{\columnwidth}
        ...
        \caption{%
            ...
            Error bars indicate the \SI{95}{\percent} \acp{CI}, calculated using a two-sample T-test.
        }
    \end{subfigure}
...
\begin{figure}
    ...
    \begin{subfigure}[]{\columnwidth}
        \centering
        \includegraphics[width=\textwidth]{figs/new_model/sampling_junjue.png}
        \caption{%
    ...
    \begin{subfigure}[]{\columnwidth}
        \centering
        \includegraphics[width=\textwidth]{figs/new_model/diff_sampling_junjue.png}
        \caption{%
            Percentage difference in mean number of samples per step.
            Error bars indicate the \SI{95}{\percent} \acp{CI}, calculated using a two-sample T-test.
            \todo[inline]{%
                Add greedy.
                Develop optimal sampling scheme?
                Explain grouping better?
            }
        }
    \end{subfigure}
    \caption{%
...
When using the realistic model for execution time estimation, the sampling schemes achieve between \SI{22}{\percent} and \textasciitilde\SI{25}{\percent} better average performance.
...
\todo[inline]{
    ...
    Plot energy consumption over RTT, mean energy per step over a task.
    Ground truth empirical high.
    For greedy, ideal, junjues sampling, vishnus model with gt as estimator.
}