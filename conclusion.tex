...
\todo[inline]{Comment from Bobby: Reviewers might wonder why we stuck with the Rayleigh distribution.
Manuel: I think Vishnu already fixed this in the appendix.}