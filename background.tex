...
\begin{figure}
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=.9\textwidth]{publications/2023EdgeDroid2/figs/task}
        \caption{%
...
\begin{figure}
    \centering
    \includegraphics[width=.9\textwidth]{publications/2023EdgeDroid2/figs/new_model/mu_fits_exgaussian_slice0}
    \caption{%
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{publications/2023EdgeDroid2/figs/new_model/dist_fits_neuro}
    \caption{%
