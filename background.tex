...
\todo[inline]{%
Talk about sampling, but don’t introduce greedy right away. First explain the sampling process generally (why is sampling necessary?) and then mention that different sampling strategies exist, for instance greedy ….
}
...
\todo[inline]{%
Again, turn it around. The uniform distribution is less relevant than the terms execution time, wait time and last sample etc. Introduce the distribution at the end of the paragraph.
}
